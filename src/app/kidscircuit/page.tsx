    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <header className="bg-white shadow-sm border-b-2 border-purple-200">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <Link 
            href="/play" 
            className="flex items-center bg-white hover:bg-gray-100 text-purple-600 font-semibold px-4 py-2 rounded-xl border-2 border-purple-200 transition-all duration-200 hover:shadow-md hover:border-purple-300"
          >
            <ArrowLeft className="h-5 w-5 mr-2" />
            <span>Back to Circuit Kids</span>
          </Link>
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-r from-blue-500 to-green-500 p-3 rounded-xl">
              <Zap className="h-6 w-6 text-white" />
            </div>
            <span className="text-2xl font-black text-gray-800">CirKit Builder</span>
          </div>
        </div>
